    ...
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        <div className={styles.textColumn}>
          ...
          We pride ourselves on our collaborative work environment, where communication and teamwork are paramount. Regular team meetings, code reviews, and pair programming sessions foster a culture of continuous learning and improvement. This collaborative approach not only helps us to tackle complex problems more efficiently but also ensures that our code is clean, maintainable, and scalable. Our commitment to best practices and staying up-to-date with the latest industry trends allows us to implement cutting-edge technologies and innovative solutions.
          <p>
